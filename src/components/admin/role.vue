  ...
  <div>
    ...
    <el-card>
      <el-row :gutter="20">
        ...
        <el-col :span="4">
          <el-button type="primary" @click="showDialog(null)">添加角色</el-button>
        </el-col>
      </el-row>
      <!-- 角色列表 -->
      <el-table v-loading="getRoleListLoading" :data="rolelist" border stripe>
        ...
        <el-table-column label="角色简介" prop="intro"></el-table-column>
        <el-table-column label="创建时间" prop="create_time"></el-table-column>
        <el-table-column label="更新时间" prop="update_time"></el-table-column>
        <el-table-column label="状态" width="63px">
          <template v-slot="{row}">
            <el-switch @change="roleStatusChanged(row)" :active-value="1" :inactive-value="0" v-model="row.status"></el-switch>
          </template>
        </el-table-column>
        <el-table-column label="操作" width="120px">
          <template v-slot="{row}">
            <el-button type="primary" @click="showDialog(row)" icon="el-icon-edit" size="mini"></el-button>
            <el-button type="danger" @click="delRole(row.id)" icon="el-icon-delete" size="mini"></el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 分页 -->
    ...
    <el-dialog :title="dialogTitle" width="500px" ref="dialog" :visible.sync="dialogVisible" @close="dialogClose">
      <el-form :model="roleInfoRorm" :rules="roleInfoRormRules" ref="roleInfoRormRef" label-width="100px">
        <el-form-item label="角色名称" prop="name">
          <el-input v-model="roleInfoRorm.name"></el-input>
        </el-form-item>
        <el-form-item label="角色简介" prop="intro">
          <el-input v-model="roleInfoRorm.intro" type="intro"></el-input>
        </el-form-item>
