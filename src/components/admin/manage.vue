		...
		<el-card>
			...
			<div class="pagination">
				<el-pagination :hide-on-single-page="total / queryInfo.pagesize < 2" @size-change="handleSizeChange"
				 @current-change="handleCurrentChange" :current-page="queryInfo.pagenum" :page-sizes="[8, 30, 50, 100]" :page-size="queryInfo.pagesize"
		...
		methods: {
			...
			submitForm() {
				...
				this.$refs.adminInfoRormRef.validate(async valid => {
					...
					this.method()('admin' + id, this.adminInfoRorm).then(
						res => {
							console.log(res)
